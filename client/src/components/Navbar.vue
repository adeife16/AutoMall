<template>
  <nav class="dark-gray shadow color-yellow sticky top-0 z-50">
    <div
      class="flex justify-between items-center px-4 py-2 mx-auto lg:max-w-7xl lg:px-8"
    >
      ...
      >
        <Bars3Icon
          class="w-6 h-6 color-red transform transition duration-300"
      ...
      <transition name="fade">
        <div
          v-if="isOpen"
          class="fixed inset-0 bg-black opacity-50 z-90"
          @click="toggleMenu"
        ></div>
      </transition>
      ...
      >
        <div>
          <XMarkIcon
            class="color-red mx-3 mt-3 h-12 w-12 float-right"
            @click="toggleMenu"
          />
        </div>
        <ul class="flex flex-col w-full pt-4 nav-lists">
          ...
          <li>
            <router-link
              to="/"
              class="block py-3 px-4 rounded-md color-yellow hover:underline"
              >Home</router-link
            >
          </li>
          <li class="relative">
            ...
            <transition name="fade">
              ...
              >
                <li>
                  <a
                    href="#"
                    class="block px-4 py-2 color-yellow hover:underline"
                    >Option 1</a
                  >
                </li>
                <li>
      ...
      <ul class="hidden lg:flex flex-col lg:flex-row lg:space-x-4 color-yellow">
        <li>
          <router-link to="/" class="px-3 py-2 rounded-md hover:color-yellow"
            >Home</router-link
          >
        </li>
        <li class="relative">
          ...
          <ul
            ...
            :class="{
              hidden: !dropdownOpen,
              'animate-slide-in-top': dropdownOpen,
            }"
          >
            <li>
              <a href="#" class="block px-4 py-2 hover:color-yellow"
                >Option 1</a
              >
            </li>
            <li>
        ...
        <li>
          <a href="#" class="px-3 py-2 rounded-md hover:color-yellow"
            >Contact</a
          >
        </li>
        <li v-if="!isLoggedIn">
