...
INSERT INTO `admin` (`id`, `admin_id`, `first_name`, `last_name`, `email`, `password`, `picture`) VALUES
(1, 'ADMIN_epr34j4d', 'Opeyemi', 'Dada', 'admin@jaad.com', '$2y$10$FL5DPsMUhjj9c2tBGySD7OqhJLLvr41BZUsPP28C68BOwd2RPRjCC', 'ADMIN_epr34j4d.jpg');
...
CREATE TABLE `company` (
  ...
  `password` varchar(200) NOT NULL,
  `company_number` varchar(13) NOT NULL,
  `company_number_optional` varchar(13) DEFAULT NULL,
  `employees` int(200) NOT NULL,
...
CREATE TABLE `employment` (
  ...
  `status` enum('employed','pending') NOT NULL DEFAULT 'pending',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf32 COMMENT='Local governments in Nigeria.';

--
-- Dumping data for table `local_governments`
--

INSERT INTO `local_governments` (`id`, `state_id`, `lga_name`) VALUES
(1, 1, 'Aba North'),
(2, 1, 'Aba South'),
(3, 1, 'Arochukwu'),
(4, 1, 'Bende'),
...
CREATE TABLE `rider` (
  ...
  `phone_option` varchar(13) DEFAULT NULL,
  `state` int(11) NOT NULL,
  `city` int(11) NOT NULL,
  `about` text NOT NULL,
  `experience` int(11) NOT NULL,
  `previous_employment` varchar(100) NOT NULL,
  `previous_employment_address` text NOT NULL,
  `previous_employment_phone` varchar(13) NOT NULL,
  `picture` varchar(200) NOT NULL,
  ...
  `status` enum('active','pending','disabled') NOT NULL DEFAULT 'pending',
  `employment_status` enum('Employed','Unemployed') NOT NULL DEFAULT 'Unemployed',
  `date_registered` date NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf32 COMMENT='States in Nigeria.';
