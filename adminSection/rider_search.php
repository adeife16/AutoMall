...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">SEARCH RIDER</h1>
</div>
          ...
          <div class="action-div" id="action-div">
            <form class="form-inline " id="name-form" action="" method="post">
              <div class="form-group">
                <input type="text" name="rider-name" class="form-control" id="rider-name" value="" placeholder="Enter Rider Name">
              </div>
            </form>
            <form class="action-form hide" id="location-form" action="" method="post">
              <div class="form-group w-100 ml-2">
                <span>State:</span>
                <select class="form-control" id="rider-state">
                </select>
              </div>
              <div class="form-group w-100 ml-2">
                <span>City:</span>
                <select class="form-control" id="rider-city">
                </select>
              </div>
...
<div class="row justify-content-center">
  <div class="col-lg-12">
    <div class="display-div" id="display-div">
      <div class="table-responsive">
        <table class="table  table-bordered" id="rider-table" width="100%" cellspacing="0">
          <thead>
            <tr>
              <th>Picture</th>
              <th>Name</th>
  ...
  <div class="modal-content">
    ...
    <div class="modal-body"><span style="color: red">Delete Rider? This process cannot be undone!</span></div>
