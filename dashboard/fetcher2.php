      ...
      function getTrim(id){
        ...
        .done(function(res) {
          ...
          // let i=0;
              ...
              url = 'https://jiji.ng/get_attribute_choices/1165?parent_value_id='+res[0].trim_id;
              ...
              setTimeout(function() {
                fuel(url, res[0].trim_id, id);
              },5000)
            }
        })
      }

          function fuel(url, trim, id){
            sessionStorage.setItem("current", id); 08166585179
          var list = {
                    'cache': false,
                    'dataType': "json",
                    "async": true,
