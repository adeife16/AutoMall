          ...
          <div class="signup-box">
            <div class="tabs_menu mt-50 text-center">
              <ul class="nav" id="myTab" role="tablist">
                ...
                <li>
                  <a style="display: inline-block" id="employee-tab" data-toggle="tab" href="#employee" role="tab" aria-controls="employee" aria-selected="fasse">Rider</a>
                </li>
              </ul>
            </div>
            <br>
            ...
            <div class="tab-pane fade" id="employee" role="tabpanel" aria-labelledby="employee-tab">
              <div class="employee-form">
                ...
                <form action="" class="form" id="employee-form" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label for="employee_phone_optional">Phone Number  (Optional)</label>
                    <input type="text" name="employee_phone_optional" id="employee_phone_optional" class="form-control" placeholder="Phone Number" aria-describedby="helpId">
                    <small id="helpId" class="text-danger">Optional</small>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="employee_experience" id="employee_experience" class="form-control" min="1" placeholder="Years of Experience" aria-describedby="helpId">
                  </div>
                  <div class="form-group">
                    <label for="employee_previous_employment">Previous Employment</label>
                    <input type="text" name="employee_previous_employment" id="employee_previous_employment" class="form-control" placeholder="Previous Employment" aria-describedby="helpId">
                    <small id="helpId" class="text-danger">Your place of previous employment</small>
                  </div>
                  <div class="form-group">
                    <label for="employee_previous_address">Address</label>
                    <input type="text" name="employee_previous_address" id="employee_previous_address" class="form-control" placeholder="Address of previous employment" aria-describedby="helpId">
                    <small id="helpId" class="text-danger">Your address of previous employment</small>
                  </div>
                  <div class="form-group">
                    <label for="employee_previous_phone">Phone Number</label>
                    <input type="text" name="employee_previous_phone" id="employee_previous_phone" class="form-control" placeholder="Phone Number of Previous Employer" aria-describedby="helpId">
                    <small id="helpId" class="text-danger">Phone number of your previous employer</small>
                  </div>
                  <hr>
                  <br>
                  ...
                  <div class="form-group">
                    <label for="employee_id">Drivers/Riders License</label>
                    <div class="file-upload5">
                      <button class="file-upload-btn btn blue color-white" type="button" onclick="$('.file-upload-input5').trigger( 'click' )">Upload File</button>

                      <div class="image-upload-wrap5">
                        <div class="drag-text">
                          <input class="file-upload-input5" type='file' id="file-upload5" name="employee_license" onchange="readURL5(this);" accept=".pdf, .jpg, .jpeg, .png" />
                          <p>Drag and drop a file or click to upload</p>
                        </div>
                      </div>
                      <div class="file-upload-content5">
                        <img class="file-upload-image5" src="#" alt="your image" />
                        <div class="file-name5"></div>
                        <div class="file-size5"></div>
                        <div class="image-title-wrap">
                          <button type="button" onclick="removeUpload5()" class="remove-image blue color-white">Remove</button>
                        </div>
                      </div>
                    </div>
                    <small id="helpId" class="text-danger">File size limit is 1Mb</small>
                    <div id="bar-8" class="bar-main-container blue hide">
                      <div class="wrap">
                        <div class="bar-percentage5" data-percentage5="100"></div>
                        <div class="bar-container">
                          <div class="bar"></div>
                        </div>
                      </div>
                  ...
                  <div class="form-group">
                    <label for="employee_reference_name">Reference Name</label>
                    <input type="text" name="employee_reference_name" id="employee_reference_name" class="form-control" placeholder="Enter your reference name" aria-describedby="helpId">
                    <small id="helpId" class="text-danger">Optional</small>
                  </div>
                  <div class="form-group">
                    <label for="employee_reference_address">Address</label>
                    <textarea name="employee_reference_address" id="employee_reference_address" class="form-control" placeholder="Enter reference address" aria-describedby="helpId"></textarea>
                    <small id="helpId" class="text-danger">Optional</small>
                  </div>
                  <br>
                  <hr class="">
