$(document).ready(function(){
    ...
    $("#employee_signup").click(function(e){
        ...
        if($("#employee_city, #employee_gender, #employee_dob, #file-upload4, #file-upload3, #file-upload5, #employee_experience").val() ===""){
            $("#employee_city").addClass("red-border");
            $("#employee_gender").addClass("red-border");
            $("#employee_dob").addClass("red-border");
            $("#employee_experience").addClass("red-border");
            error = 1;
            alert_failure("Please fill the required form fields and uploads");
        }
        else if(password.length < 8){
        ...
        // else if($("#employee_phone_optional").val() != ""){
        //     if(phone_option.success == false){
        //     error = 1;
        //     alert_failure(phone_option.msg);
        //     }
        // }
        else if(employee_previous_phone.success == false){
            error = 1;
            alert_failure(employee_previous_phone.msg);
        }
