                  ...
                  <div class="tab-pane fade" id="edit-profile" role="tabpanel" aria-labelledby="edit-tab">
                    ...
                    <div class="rider-div">
                      ...
                      <form class="profile-edit-rider hide" id="profile-edit-rider" action="" method="post">
                        ...
                        <div class="form-group">
                          <label for="rider_edit_phone2">Phone Number (Optional)</label>
                          <input type="text" class="form-control" name="rider_edit_phone2" id="rider_edit_phone2">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          <label for="rider_edit_experience">Experience</label>
                          <input type="number" class="form-control" name="rider_edit_experience" id="rider_edit_experience">
                        </div>
                        <div class="form-group">
                        ...
                        <h5 class="color-blue">Previous Employment</h5>
                        <div class="form-group">
                          <label for="rider_edit_companyname">Company Name</label>
                          <input type="text" class="form-control" name="rider_edit_companyname" id="rider_edit_companyname">
                        </div>
                        <div class="form-group">
                          <label for="rider_edit_companyaddress">Company Address</label>
                          <textarea name="rider_edit_companyaddress" rows="8" cols="80" class="form-control" id="rider_edit_companyaddress">

                          </textarea>
                        </div>
                        <div class="form-group"><label for="rider_edit_companyphone">Company Phone Number</label>
                          <input type="text" class="form-control" name="rider_edit_companyphone" id="rider_edit_companyphone">
                        </div>
                        <div class="form-group">
