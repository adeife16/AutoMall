    ...
    <div class="row px-xl-5 pt-5">
        <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            <a href="" class="text-decoration-none">
                <img src="img/AUTOMALL.png" alt="" class="logo-img">
            </a>
...
<?php if ($title == "Sign Up"): ?>
    ...
    <script src="ajax/signup.js" charset="utf-8"></script>
    <script src="js/validate.js" charset="utf-8"></script>
<?php endif; ?>
<!-- verify page -->
<?php if ($title == "Account Verify"): ?>
    <script src="ajax/verify.js" charset="utf-8"></script>
    <script src="js/verify.js" charset="utf-8"></script>
<?php endif; ?>
<!-- merchant signup -->
<?php if ($title == "Sign Up-Merchant"): ?>
    <script src="node_modules/jquery-validation/dist/jquery.validate.min.js" charset="utf-8"></script>
    <script src="node_modules/jquery-validation/dist/additional-methods.min.js" charset="utf-8"></script>
    <script src="ajax/merchant_signup.js" charset="utf-8"></script>
    <script src="js/merchant_signup.js" charset="utf-8"></script>
    <script src="js/validate.js" charset="utf-8"></script>
